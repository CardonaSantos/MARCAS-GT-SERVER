...
const municipios = [
  ...
  // Chimaltenango (departamentoId: 3)
  ...
  // Huehuetenango (departamentoId: 8)
  ...
  // Quetzaltenango (departamentoId: 13)
  ...
  // Sacatepéquez (departamentoId: 16)
  ...
  // Suchitepéquez (departamentoId: 20)
